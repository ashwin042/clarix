...
>
    ...
    <div x-show="show"
        ...
        class="relative bg-white dark:bg-slate-900 rounded-2xl shadow-2xl dark:shadow-black/50 dark:ring-1 dark:ring-white/5 w-full max-w-md z-10 overflow-hidden">

        {{-- Header --}}
        <div class="px-6 pt-6 pb-0">
            <div class="flex items-center gap-3">
                <div class="flex-shrink-0 w-10 h-10 rounded-full bg-red-100 dark:bg-red-500/10 flex items-center justify-center">
                ...
                <div>
                    ...
                    @if($description)
                        <p class="text-sm text-gray-500 dark:text-slate-400 mt-0.5">{{ $description }}</p>
                    @endif
                </div>
            </div>
        </div>
        ...
        <div class="px-6 py-4 space-y-4">
            ...
            @if(count($consequences))
                <div class="bg-red-50 dark:bg-red-500/8 border border-red-200 dark:border-red-500/20 rounded-lg p-3">
            ...
            <div>
                ...
                <input
                    ...
                    :class="confirmText.length > 0 && !isValid
                        ? 'border-red-300 dark:border-red-500/50 focus:ring-red-500 bg-red-50 dark:bg-red-500/8'
                        : 'border-gray-300 dark:border-slate-700 focus:ring-indigo-500 bg-white dark:bg-slate-800 dark:text-slate-200'"
