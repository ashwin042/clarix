<x-app-layout pageTitle="New Unit">
    <div class="p-6 max-w-lg">
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-900 mt-3">New Unit</h1>
        </div>
            ...
            <form action="{{ route('admin.units.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}"
                           ...
                           placeholder="e.g. Content Unit A">
                    @error('name') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
                </div>
                <div class="flex gap-3 pt-2">
                    <button type="submit" class="px-5 py-2 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 transition-colors">Create Unit</button>
