...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .reveal-d6 { transition-delay:.34s; }
        ...
        .btn-ghost:hover { background: rgba(124,58,237,.06); color: #6d28d9; border-color: rgba(124,58,237,.3); }
        ...
        .about-stat {
            ...
            box-shadow: 0 4px 20px rgba(109,40,217,.06);
            padding: 28px 24px;
            transition: transform .2s ease, box-shadow .2s ease;
        }
        .about-stat:hover { transform: translateY(-4px); box-shadow: 0 12px 36px rgba(109,40,217,.12); }

        /* ── Why Clarix image cards ── */
        .why-card {
            position: relative; overflow: hidden; border-radius: 22px; height: 360px;
            transition: transform .3s ease, box-shadow .3s ease;
        }
        .why-card:hover { transform: translateY(-6px); box-shadow: 0 28px 64px rgba(0,0,0,.18); }
        .why-bg {
        ...
        .feat-card:hover { transform: translateY(-5px); box-shadow: 0 20px 52px rgba(124,58,237,.13); }

        /* ── Pricing ── */
        .price-card { transition: transform .2s, box-shadow .2s; }
        .price-card:hover { transform: translateY(-5px); box-shadow: 0 24px 52px rgba(0,0,0,.1); }
        .price-featured {
            background: linear-gradient(150deg, #6d28d9 0%, #7c3aed 55%, #8b5cf6 100%);
            box-shadow: 0 24px 64px rgba(109,40,217,.38);
            transform: scale(1.04);
        }
        .price-featured:hover { transform: scale(1.04) translateY(-5px); }
        ...
        .testi-card:hover { transform: translateY(-5px); box-shadow: 0 20px 52px rgba(109,40,217,.16); }
...
<nav id="navbar" class="navbar fixed top-0 left-0 right-0 z-50">
    ...
    <div id="mobile-menu" class="md:hidden border-t bg-white/96 backdrop-blur-lg" style="border-color:rgba(139,92,246,.1)">
        <div class="px-5 py-5 space-y-1">
            <a href="#features"     onclick="closeMobileMenu()" class="block text-sm text-gray-600 font-medium px-3 py-3 rounded-lg hover:bg-violet-50 hover:text-violet-700 transition-colors">Features</a>
            <a href="#use-cases"    onclick="closeMobileMenu()" class="block text-sm text-gray-600 font-medium px-3 py-3 rounded-lg hover:bg-violet-50 hover:text-violet-700 transition-colors">Use Cases</a>
            <a href="#pricing"      onclick="closeMobileMenu()" class="block text-sm text-gray-600 font-medium px-3 py-3 rounded-lg hover:bg-violet-50 hover:text-violet-700 transition-colors">Pricing</a>
            <a href="#testimonials" onclick="closeMobileMenu()" class="block text-sm text-gray-600 font-medium px-3 py-3 rounded-lg hover:bg-violet-50 hover:text-violet-700 transition-colors">Testimonials</a>
            <div class="pt-3 pb-1">
                <a href="{{ route('login') }}" class="btn-primary block text-sm font-semibold text-white rounded-xl px-4 py-3 text-center">
                    Get started free
                </a>
            </div>
        </div>
...
<section class="hero-bg relative overflow-hidden" style="min-height:100vh; padding-top:74px;">
    ...
    <div class="absolute top-20 -left-40 w-[500px] h-[500px] rounded-full blur-3xl pointer-events-none"
         style="background:rgba(167,139,250,.16)"></div>
    <div class="absolute top-52 -right-28 w-80 h-80 rounded-full blur-3xl pointer-events-none"
         style="background:rgba(196,181,253,.18)"></div>

    <div class="relative max-w-6xl mx-auto px-6 sm:px-10 pt-24 pb-0 text-center">

        {{-- Pill badge --}}
        <div class="anim-fade-up inline-flex items-center gap-2 rounded-full px-4 py-2 mb-8"
        ...
        {{-- Headline --}}
        <h1 class="anim-fade-up anim-d1 font-black text-[2.4rem] sm:text-[3.1rem] lg:text-[3.8rem] leading-[1.06] tracking-[-0.04em] text-gray-900 max-w-[740px] mx-auto mb-7">
            The smarter way to manage<br>
            <span class="gradient-text">projects, teams and payments</span>
        </h1>

        {{-- Subheading --}}
        <p class="anim-fade-up anim-d2 text-[1.05rem] sm:text-lg text-gray-500 leading-[1.75] max-w-[520px] mx-auto mb-10">
        ...
        {{-- CTAs --}}
        <div class="anim-fade-up anim-d3 flex flex-col sm:flex-row items-center justify-center gap-4 mb-5">
            <a href="{{ route('login') }}"
               class="btn-primary text-white font-bold text-[15px] px-8 py-4 rounded-xl inline-flex items-center gap-2">
                Get started free
            ...
            <a href="#use-cases"
               class="btn-ghost text-gray-600 font-semibold text-[15px] px-8 py-4 rounded-xl inline-flex items-center gap-2 border border-gray-200">
                See how it works
            </a>
        </div>

        <p class="anim-fade-up anim-d4 text-xs text-gray-400 mb-20">No credit card required · Free to get started</p>

        {{-- Floating mock cards --}}
        <div class="anim-scale-in anim-d5 relative mx-auto" style="max-width:640px; height:300px;">

            {{-- Left: Credits card --}}
            <div class="mock-card card-float-a absolute w-[205px]"
                 style="left:10px; top:40px; z-index:2;">
                <div class="p-5">
                    ...
                    <div class="text-[1.5rem] font-black text-gray-900 tracking-tight mb-1">Rs 12,450</div>
            ...
            <div class="mock-card card-float-b absolute w-[285px]"
                ...
                <div class="flex items-center justify-between px-4 py-3.5 border-b border-gray-100">
                    ...
                    <span class="text-[10px] font-semibold text-violet-600 bg-violet-50 px-2 py-1 rounded-full">4 tasks</span>
                </div>
                <div class="p-3 space-y-2">
                    ...
                    @endphp
                    @foreach($tasks as $t)
                    <div class="flex items-center gap-2 px-2 py-2 rounded-lg hover:bg-gray-50 transition-colors">
    ...
    {{-- Wave divider --}}
    <div class="relative mt-8 -mb-px">
        <svg viewBox="0 0 1440 70" xmlns="http://www.w3.org/2000/svg" class="w-full"
             preserveAspectRatio="none" style="height:70px; display:block;">
            <path d="M0 70L60 58C120 46 240 22 360 16C480 10 600 22 720 32C840 42 960 46 1080 42C1200 38 1320 24 1380 17L1440 10V70H0Z" fill="white"/>
        </svg>
    </div>
</section>
...
<section id="about" class="bg-white py-28">
    <div class="max-w-7xl mx-auto px-6 sm:px-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24 items-center">
            ...
            {{-- Left: text --}}
            <div class="reveal">
                <div class="s-label mb-7">About Clarix</div>
                <h2 class="text-[2rem] sm:text-[2.5rem] font-black tracking-tight text-gray-900 leading-tight mb-6">
                    We built Clarix because<br class="hidden sm:block">
                    <span class="gradient-text">we have been there</span>
                </h2>
                <p class="text-gray-500 text-[1.05rem] leading-[1.8] mb-5">
                    Managing content teams with spreadsheets, WhatsApp threads and disconnected invoicing tools is a daily frustration. Credits get miscounted, tasks get missed, and nobody knows who is waiting on what.
                </p>
                <p class="text-gray-500 text-[1.05rem] leading-[1.8] mb-10">
                    Clarix replaces that chaos with a single, role-aware portal. Admins configure, project managers assign, writers deliver and everyone gets paid accurately. Simple, transparent and built for the way creative teams actually operate.
                </p>
                <div class="flex flex-col sm:flex-row items-start gap-4">
                    <a href="{{ route('login') }}"
                       class="btn-primary text-white font-semibold text-[14.5px] px-6 py-3 rounded-xl inline-flex items-center gap-2">
                        Start for free
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 7l5 5m0 0l-5 5m5-5H6"/>
                        </svg>
                    ...
                    <a href="#use-cases"
                       class="btn-ghost text-gray-600 font-semibold text-[14.5px] px-6 py-3 rounded-xl inline-flex items-center gap-2 border border-gray-200">
                        See how it works
                    </a>
                </div>
            </div>
            ...
            {{-- Right: stat cards --}}
            <div class="grid grid-cols-2 gap-5 reveal reveal-d2">
                ...
                <div class="about-stat">
                    ...
                    <div class="text-[2rem] font-black text-gray-900 tracking-tight leading-none mb-2">500+</div>
                    <div class="text-sm font-medium text-gray-500">Teams onboarded</div>
                </div>
                ...
                <div class="about-stat">
                    ...
                    <div class="text-[2rem] font-black text-gray-900 tracking-tight leading-none mb-2">50K+</div>
                ...
                <div class="about-stat">
                    ...
                    <div class="text-[2rem] font-black text-gray-900 tracking-tight leading-none mb-2">Rs 2M+</div>
                    <div class="text-sm font-medium text-gray-500">Credits processed</div>
                </div>
                ...
                <div class="about-stat">
                    ...
                    <div class="text-[2rem] font-black text-gray-900 tracking-tight leading-none mb-2">99.9%</div>
...
<section id="use-cases" class="py-28" style="background:linear-gradient(180deg,#f8f7ff 0%,#f3f0ff 100%)">
    <div class="max-w-7xl mx-auto px-6 sm:px-10">

        <div class="text-center mb-16 reveal">
            <div class="s-label mb-6">✦ One Stop Solution</div>
            <h2 class="text-[2rem] sm:text-[2.5rem] font-black tracking-tight text-gray-900 mb-5 leading-tight">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="why-card reveal reveal-d1">
                ...
                <div class="why-glass">
                    <h3 class="text-white font-bold text-[1.05rem] mb-2.5">Effortless Collaboration</h3>
            ...
            <div class="why-card reveal reveal-d2">
                ...
                <div class="why-overlay"></div>
                <div class="why-glass">
                    <h3 class="text-white font-bold text-[1.05rem] mb-2.5">Real-time Credit Tracking</h3>
            ...
            <div class="why-card reveal reveal-d3">
                ...
                <div class="why-overlay"></div>
                <div class="why-glass">
                    <h3 class="text-white font-bold text-[1.05rem] mb-2.5">Role-Based Access</h3>
...
<section id="features" class="bg-white py-28">
    <div class="max-w-7xl mx-auto px-6 sm:px-10">
        ...
        <div class="text-center mb-16 reveal">
            <div class="s-label mb-6">✦ Everything Covered</div>
            <h2 class="text-[2rem] sm:text-[2.5rem] font-black tracking-tight text-gray-900 mb-5 leading-tight">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7">
            ...
            <div class="feat-card reveal {{ $fd[$i] }} bg-white rounded-2xl p-8 shadow-sm group"
                 style="border:1px solid rgba(139,92,246,.09);">
                <div class="w-12 h-12 rounded-xl {{ $f['cls'] }} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-200">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">{!! $f['icon'] !!}</svg>
                </div>
                <h3 class="font-bold text-gray-900 mb-3 text-[15.5px]">{{ $f['title'] }}</h3>
...
{{-- ══════════════════ PRICING ══════════════════ --}}
<section id="pricing" class="py-28" style="background:linear-gradient(180deg,#f8f7ff 0%,#ede9fe 100%)">
    <div class="max-w-7xl mx-auto px-6 sm:px-10">

        <div class="text-center mb-16 reveal">
            <div class="s-label mb-6">Pay as you grow</div>
            <h2 class="text-[2rem] sm:text-[2.5rem] font-black tracking-tight text-gray-900 mb-5 leading-tight">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-center">
            ...
            {{-- Free --}}
            <div class="price-card reveal reveal-d1 bg-white rounded-2xl p-8 shadow-sm"
                ...
                <div class="mb-8">
                    ...
                    <p class="text-sm text-gray-500 mt-3 leading-relaxed">For individuals getting started.</p>
                </div>
                <a href="{{ route('login') }}"
                   class="w-full block text-center py-3 rounded-xl text-sm font-semibold text-violet-700 border-2 border-violet-200 hover:bg-violet-50 transition-colors mb-8">
                    Get started free
                </a>
            ...
            {{-- Standard (featured) --}}
            <div class="price-card price-featured reveal reveal-d2 rounded-2xl p-8 relative overflow-hidden">
                <div class="absolute top-5 right-5 text-[9px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full"
                ...
                <div class="mb-8">
                    ...
                    <p class="text-sm mt-3 leading-relaxed" style="color:rgba(221,214,254,.8)">For growing teams.</p>
                </div>
                <a href="{{ route('login') }}"
                   class="w-full block text-center py-3 rounded-xl text-sm font-semibold text-violet-700 bg-white hover:bg-violet-50 transition-colors mb-8 shadow-sm">
                    Get started
                </a>
                <ul class="space-y-3.5">
                    ...
                    <li class="flex items-center gap-3 text-sm" style="color:rgba(255,255,255,.88)">
            ...
            {{-- Premium --}}
            <div class="price-card reveal reveal-d3 bg-white rounded-2xl p-8 shadow-sm"
                 style="border:1px solid rgba(139,92,246,.12);">
                <div class="mb-8">
                    ...
                    <p class="text-sm text-gray-500 mt-3 leading-relaxed">For established businesses.</p>
                </div>
                <a href="{{ route('login') }}"
                   class="w-full block text-center py-3 rounded-xl text-sm font-semibold text-violet-700 border-2 border-violet-200 hover:bg-violet-50 transition-colors mb-8">
                    Get started
            ...
            {{-- Enterprise --}}
            <div class="price-card reveal reveal-d4 rounded-2xl p-8 shadow-sm"
                 style="border:1px solid rgba(139,92,246,.12); background:linear-gradient(160deg,#f5f3ff 0%,#fff 100%);">
                <div class="mb-8">
                    ...
                    <p class="text-sm text-gray-500 mt-3 leading-relaxed">For large organizations.</p>
                </div>
...
<section id="testimonials" class="py-28 bg-white">
    <div class="max-w-7xl mx-auto px-6 sm:px-10">
        ...
        <div class="text-center mb-16 reveal">
            <div class="s-label mb-6">What people say</div>
            <h2 class="text-[2rem] sm:text-[2.5rem] font-black tracking-tight text-gray-900 mb-5 leading-tight">
                What our users say
            </h2>
            <p class="text-gray-500 text-base sm:text-lg max-w-lg mx-auto leading-relaxed">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="testi-card reveal reveal-d{{ $i + 1 }} p-8 flex flex-col"
                 style="background:rgba(248,247,255,.9); border:1px solid rgba(139,92,246,.1); box-shadow:0 4px 24px rgba(109,40,217,.07);">
                ...
                <p class="text-gray-600 text-[15px] leading-[1.75] flex-1 mb-8">"{{ $t['quote'] }}"</p>
                <div class="flex items-center gap-4 pt-6" style="border-top:1px solid rgba(139,92,246,.1)">
                    <div class="w-10 h-10 rounded-full {{ $t['bg'] }} flex items-center justify-center flex-shrink-0">
                        <span class="text-xs font-bold {{ $t['text'] }}">{{ $t['initials'] }}</span>
                    </div>
                    <div>
                        <div class="text-sm font-bold text-gray-900">{{ $t['name'] }}</div>
                        <div class="text-xs text-gray-500 mt-0.5">{{ $t['role'] }} · {{ $t['company'] }}</div>
                    </div>
                </div>
            </div>
            @endforeach
...
<footer class="site-footer text-gray-400">
    <div class="max-w-7xl mx-auto px-6 sm:px-10 pt-20 pb-10">

        <div class="grid grid-cols-2 md:grid-cols-5 gap-12 pb-14"
            ...
            <div class="col-span-2">
                <a href="/" class="flex items-center gap-3 mb-5">
                    <div class="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0"
                         style="background:linear-gradient(135deg,#7c3aed,#5b21b6)">
                        <span class="text-white font-black text-base leading-none">C</span>
                    </div>
                    <span class="text-white font-bold text-[18px] tracking-tight">Clarix</span>
                </a>
                <p class="text-sm leading-[1.75] max-w-[230px]"
            ...
            <div>
                <h4 class="text-[10px] font-bold uppercase tracking-widest mb-5"
                    style="color:rgba(255,255,255,.38)">{{ $heading }}</h4>
                <ul class="space-y-3.5">
                    @foreach($links as $link)
                    <li>
                        <a href="{{ $heading === 'Company' && $link === 'About' ? '#about' : '#' }}"
                           class="footer-link">{{ $link }}</a>
                    </li>
                    @endforeach
                </ul>
            </div>
