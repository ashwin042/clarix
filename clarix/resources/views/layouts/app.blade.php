    ...
    >
        ...
        <nav class="flex-1 px-2.5 py-4 space-y-0.5 overflow-y-auto overflow-x-hidden scrollbar-none">
            ...
            <a href="{{ route('dashboard') }}"
                class="group flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ request()->routeIs('dashboard') ? 'bg-indigo-600 text-white' : 'text-gray-600 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-slate-800/50 hover:text-gray-900 dark:hover:text-slate-100' }}">
            ...
            <a href="{{ route('home') }}"
                ...
                <span x-show="sidebarOpen" x-transition:enter="transition-opacity duration-150 delay-75" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" class="whitespace-nowrap">Home</span>
            </a>
            @endif
            ...
            <div x-show="!sidebarOpen" class="py-2">
                <div class="border-t border-gray-200 dark:border-slate-800/50 mx-2"></div>
            </div>
            ...
            <div>
                <button type="button"
                    ...
                    :class="[openMenu === 'units' ? 'bg-gray-100 dark:bg-slate-800/60 text-gray-900 dark:text-slate-100' : 'text-gray-600 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-slate-800/50 hover:text-gray-900 dark:hover:text-slate-100', !sidebarOpen ? 'justify-center' : '']">
                ...
                <div x-show="openMenu === 'units' && sidebarOpen"
                    ...
                    <a href="{{ route('admin.units.index') }}" class="flex items-center pl-11 pr-3 py-1.5 rounded-lg text-xs text-gray-500 dark:text-slate-400 dark:hover:bg-slate-800/50 dark:hover:text-slate-200 hover:bg-gray-100 hover:text-gray-800 transition-colors">Manage Units</a>
                </div>
            </div>
            @endif
            ...
            <div>
                <button type="button"
                    ...
                    class="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors"
                    :class="[openMenu === 'users' ? 'bg-gray-100 dark:bg-slate-800/60 text-gray-900 dark:text-slate-100' : 'text-gray-600 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-slate-800/50 hover:text-gray-900 dark:hover:text-slate-100', !sidebarOpen ? 'justify-center' : '']">
                    <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
            ...
            <div>
                <button type="button"
                    ...
                    class="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors"
                    :class="[openMenu === 'tasks' ? 'bg-gray-100 dark:bg-slate-800/60 text-gray-900 dark:text-slate-100' : 'text-gray-600 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-slate-800/50 hover:text-gray-900 dark:hover:text-slate-100', !sidebarOpen ? 'justify-center' : '']">
                    <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
            ...
            <a href="{{ auth()->user()->isAdmin() ? route('admin.issues.index') : route('issues.index') }}"
                class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('issues.*') || request()->routeIs('admin.issues.*') ? 'bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-400' : 'text-gray-600 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-slate-800/50 hover:text-gray-900 dark:hover:text-slate-100' }}"
            ...
            <a href="{{ route('credits.index') }}"
                class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('credits.index') ? 'bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-400' : 'text-gray-600 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-slate-800/50 hover:text-gray-900 dark:hover:text-slate-100' }}"
                :class="sidebarOpen ? '' : 'justify-center'">
                <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
            ...
            <a href="{{ route('admin.finance') }}"
                class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('admin.finance') ? 'bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-400' : 'text-gray-600 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-slate-800/50 hover:text-gray-900 dark:hover:text-slate-100' }}"
                :class="sidebarOpen ? '' : 'justify-center'">
                <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                </svg>
                <span x-show="sidebarOpen" class="whitespace-nowrap">Financial Dashboard</span>
            </a>
            @endif
            ...
            <a href="{{ route('admin.payments') }}"
                class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('admin.payments') ? 'bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-400' : 'text-gray-600 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-slate-800/50 hover:text-gray-900 dark:hover:text-slate-100' }}"
                :class="sidebarOpen ? '' : 'justify-center'">
                <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
            ...
            {{-- Section: AI & Automation.
                 Open to every role that exists today; named explicitly so it
                 matches the role:admin,pm,writer middleware on these routes. --}}
            @if(auth()->user()->isAdmin() || auth()->user()->isPm() || auth()->user()->isWriter())
            <div x-show="sidebarOpen" class="pt-4 pb-1 px-3">
                <span class="inline-flex items-center gap-1.5">
                    <span class="text-xs font-semibold uppercase tracking-wider text-gray-400 dark:text-slate-500">AI &amp; Automation</span>
            ...
            <a href="{{ route('admin.authorization') }}"
                class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('admin.authorization') ? 'bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-400' : 'text-gray-600 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-slate-800/50 hover:text-gray-900 dark:hover:text-slate-100' }}"
                :class="sidebarOpen ? '' : 'justify-center'">
                <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
            ...
            <a href="{{ route('admin.deletion-requests') }}"
                class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('admin.deletion-requests') ? 'bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-400' : 'text-gray-600 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-slate-800/50 hover:text-gray-900 dark:hover:text-slate-100' }}"
                :class="sidebarOpen ? '' : 'justify-center'">
                <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/>
                </svg>
                <span x-show="sidebarOpen" class="whitespace-nowrap">Deletion Requests</span>
            </a>
            @endif
        ...
        {{-- User profile footer --}}
        <div class="border-t border-gray-200 dark:border-slate-800/50 p-3 flex-shrink-0">
            <div class="flex items-center gap-3 min-w-0" :class="sidebarOpen ? '' : 'justify-center'">
                <div class="flex-shrink-0 w-8 h-8 rounded-full bg-indigo-100 dark:bg-indigo-500/10 flex items-center justify-center">
                    <span class="text-xs font-semibold text-indigo-600 dark:text-indigo-400">
                        {{ strtoupper(substr(auth()->user()->name, 0, 1)) }}
                    </span>
                </div>
                <div x-show="sidebarOpen" class="min-w-0">
                    <p class="text-sm font-medium text-gray-800 dark:text-slate-200 truncate whitespace-nowrap">{{ auth()->user()->name }}</p>
                    <p class="text-xs text-gray-400 dark:text-slate-500 capitalize whitespace-nowrap">{{ auth()->user()->role }}</p>
                </div>
            </div>
        </div>
    </aside>
    ...
    <div class="flex flex-col flex-1 overflow-hidden">
        ...
        <header class="flex items-center justify-between h-16 px-4 md:px-6 bg-white dark:bg-slate-950 border-b border-gray-200 dark:border-slate-800/50 flex-shrink-0">
            <div class="flex items-center gap-3 md:gap-4">
                ...
                @isset($pageTitle)
                    <h1 class="text-base font-semibold text-gray-800 dark:text-slate-200">{{ $pageTitle }}</h1>
                @endisset
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <button
                    ...
                    class="p-2 rounded-lg text-gray-500 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-slate-800/50 transition-colors"
                ...
                <div x-data="{ open: false }" class="relative">
                    <button @click="open = !open"
                        class="flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium text-gray-700 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-800/50 transition-colors">
                        <div class="w-7 h-7 rounded-full bg-indigo-100 dark:bg-indigo-500/10 flex items-center justify-center">
                            <span class="text-xs font-semibold text-indigo-600 dark:text-indigo-400">
                                {{ strtoupper(substr(auth()->user()->name, 0, 1)) }}
                            </span>
                        </div>
                    ...
                    <div x-show="open" @click.outside="open = false" x-transition
                        class="absolute right-0 mt-1 w-48 bg-white dark:bg-slate-900 rounded-xl shadow-lg dark:shadow-2xl dark:shadow-black/40 border border-gray-200 dark:border-slate-700/60 py-1 z-50">
                        <a href="{{ route('profile') }}"
                            class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
