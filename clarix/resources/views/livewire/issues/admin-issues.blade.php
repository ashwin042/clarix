<div>
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-slate-100">Issue Management</h1>
            <p class="text-sm text-gray-500 dark:text-slate-400 mt-0.5">All submitted issues from PM and Writers</p>
        </div>
    </div>
            ...
            <table class="min-w-full divide-y divide-gray-100 dark:divide-slate-800/60">
                <thead class="bg-gray-50 dark:bg-slate-950/60">
                    <tr>
                        ...
                        <th class="px-5 py-3 text-left text-xs font-semibold text-gray-500 dark:text-slate-400 uppercase tracking-wider">Created By</th>
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-slate-800/60">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/40 transition-colors">
                        ...
                        <td class="px-5 py-3 text-sm text-gray-700 dark:text-slate-300">{{ $issue->creator->name }}</td>
                        <td class="px-5 py-3">
