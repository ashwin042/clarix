<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-800 shadow-sm dark:shadow-none p-5 flex items-start justify-between">
            <div>
                <p class="text-xs font-medium text-gray-500 dark:text-slate-400 uppercase tracking-wider">Overall Tasks</p>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-800 shadow-sm dark:shadow-none p-5 flex items-start justify-between">
            <div>
                <p class="text-xs font-medium text-gray-500 dark:text-slate-400 uppercase tracking-wider">Completed</p>
                <p class="text-3xl font-bold text-green-600 mt-1">{{ $stats['completed'] }}</p>
                <p class="text-xs text-gray-400 dark:text-slate-500 mt-1">{{ $stats['completionRate'] }}% completion rate</p>
            </div>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-800 shadow-sm dark:shadow-none p-5 flex items-start justify-between">
            <div>
                <p class="text-xs font-medium text-gray-500 dark:text-slate-400 uppercase tracking-wider">In Progress</p>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-800 shadow-sm dark:shadow-none p-5 flex items-start justify-between">
            <div>
                <p class="text-xs font-medium text-gray-500 dark:text-slate-400 uppercase tracking-wider">Overall Credits</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="px-5 py-3 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-slate-800/40 transition-colors">
                    <div class="flex items-center gap-3 min-w-0">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-xs text-gray-400 dark:text-slate-500 dark:text-slate-400 font-mono">{{ $task->task_code }}</p>
                        </div>
                    </div>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-800 shadow-sm dark:shadow-none overflow-hidden">
            <div class="px-5 py-4 border-b border-gray-100 dark:border-slate-800/60">
                <h3 class="text-sm font-semibold text-gray-800 dark:text-slate-200">Recent File Uploads</h3>
            </div>
            <div class="p-5 space-y-3">
                @forelse($recentFiles as $file)
                <div class="flex items-center gap-3 p-3 bg-gray-50 dark:bg-slate-950/50 rounded-xl">
                    <div class="w-8 h-8 rounded-lg bg-teal-50 dark:bg-teal-500/10 flex items-center justify-center flex-shrink-0">
                ...
                @empty
                    <p class="text-sm text-gray-400 dark:text-slate-500 text-center py-4">No file uploads yet.</p>
                @endforelse
            </div>
        </div>
