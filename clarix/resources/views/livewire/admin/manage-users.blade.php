<div>
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-0.5">Manage project managers and writers</p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                            ...
                            <td class="px-5 py-3">
                                @php
                                    $roleClass = match($user->role) {
                                        ...
                                        'writer' => 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 dark:text-gray-500',
                                    };
                                @endphp
        ...
        @else
            <div class="py-16 text-center dark:text-gray-400 dark:text-gray-500">
                <p class="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">No users found.</p>
            </div>
        @endif
    </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                @else
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-[11px] text-gray-400 dark:text-gray-500">Only PMs can be added by a PM</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-[11px] text-gray-400 dark:text-gray-500">Assigned to your unit automatically</p>
                    </div>
                @endif
            </div>
